...
- (void)setUpTabBarItemsAttributesForController:(CYLTabBarController *)tabBarController {
    ...
    NSDictionary *dict1 = @{
                            ...
                            CYLTabBarItemSelectedImage : @"shouye1",
                            };
    NSDictionary *dict2 = @{
                            CYLTabBarItemTitle : @"分类",
                            CYLTabBarItemImage : @"gengduo",
                            CYLTabBarItemSelectedImage : @"gengduo1",
                            };
    NSDictionary *dict3 = @{
                            CYLTabBarItemTitle : @"天气",
                            CYLTabBarItemImage : @"wolicai",
                            CYLTabBarItemSelectedImage : @"wolicai1",
                            };
    NSDictionary *dict4 = @{
                            CYLTabBarItemTitle : @"个人",
                            CYLTabBarItemImage : @"geren",
                            CYLTabBarItemSelectedImage : @"geren1"
                            };
